...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//model = glm::mat4(1);
		//model = glm::translate(modelTemp, glm::vec3(2.0f, 0.5f, -2.0f));
		...
		//=====================================Modelo de Persona==========================================================
		model = glm::mat4(1);
		modelTemp = model = glm::translate(model, PersonaPos);
		...
		model = glm::rotate(model, glm::radians(Brazos), glm::vec3(-1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		...
		model = glm::rotate(model, glm::radians(Piernas), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
